        ...
        <div className="flex gap-4 lg:absolute lg:right-4">
          {userFromStore && userFromStore.email !== "" ? (
            ...
            <div className="hidden items-center gap-3 sm:flex">
              ...
              >
                <span className="block rounded-lg text-sm bg-[#0f2c27fe] hover:bg-transparent text-white hover:text-black px-3 py-1.5 text-center  tracking-wide transition-all duration-300">
                  Contact us
                </span>
              </Link>
              {/* Login button hidden
