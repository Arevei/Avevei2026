...
const defaultImage = `${siteUrl}/assets/images/ai-native-website-manager-og-v2.jpg`
const twitterImage = `${siteUrl}/assets/images/ai-native-website-manager-og-v2.jpg`
